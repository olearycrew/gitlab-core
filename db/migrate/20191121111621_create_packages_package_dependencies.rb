...
class CreatePackagesPackageDependencies < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    add_index :packages_package_dependencies, [:package_id, :name, :version_pattern], unique: true, name: 'idx_pkgs_package_dependencies_package_id_name_version_pattern'
  end
end
