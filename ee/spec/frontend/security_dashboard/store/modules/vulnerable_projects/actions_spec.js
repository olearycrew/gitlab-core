...
describe('Vulnerable Projects actions', () => {
  const mockEndpoint = 'mock-list_endpoint';
  ...
  describe('fetchProjects', () => {
    ...
    it('calls the vulnerable projects endpoint', () => {
  ...
  describe('request projects', () => {
    it('commits the SET_LOADING and SET_HAS_ERRORS mutations', () =>
      testAction(
  ...
  describe('receiveProjectsError', () => {
    it('commits the SET_HAS_ERRORS mutation', () => {
      const projects = [];
